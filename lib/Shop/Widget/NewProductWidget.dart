        ...
        children: [
          ...
          Card(
            child: Container(
              ...
              child: TextFormField(
                enabled: enable == null ? false : null,
                validator: (str) {
                  if (str.isEmpty) {
                    return this.error;
                  }
...
Future<void> showMyDialogDouble(BuildContext context, String dialogMessage) async {
  return showDialog<void>(
    context: context,
    barrierDismissible: false, // user must tap button!
    builder: (BuildContext context) {
...
class AddCountProduct extends StatelessWidget {
  final TextEditingController controller;
  final Function add;
  final Function commit;
  final Function nagative;
  final int num;
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(icon: Icon(Icons.remove), onPressed: nagative),
        ],
      ),
    );
  }
...
// ------------------     dialog        -----------------------
Future<void> showMyDialogAddCart(
            ...
            children: <Widget>[
              ...
              Center(child: Text(name)),
                Row(
                  ...
                  children: [Text('จำนวน '+num.toString()+' ถุง'),Text('  '),Text('ราคา '+price.toString()+' บาท')],
              ),
              Center(child: Text('รวม '+sum.toString() + ' บาท'),)
            ],
          ),
        ),
        actions: <Widget>[
